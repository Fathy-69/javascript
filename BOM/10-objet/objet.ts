...
/***********************************************************************
 * 3. Définir la structure d'un objet avec une interface
 ***********************************************************************/

/*
Une interface permet de définir la forme d'un objet.
...
L'interface ne contient pas de données.
Elle sert uniquement de modèle.
*/
...
On parle alors d'objet imbriqué (nested object).
*/
